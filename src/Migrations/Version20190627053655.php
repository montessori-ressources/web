 ...
 */
final class Version20190627053655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nomenclature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by_id INTEGER NOT NULL, language_id INTEGER NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL)');
