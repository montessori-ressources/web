 ...
 */
final class Version20191029165222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nomenclature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by_id INTEGER NOT NULL, language_id INTEGER NOT NULL, mode_id INTEGER NOT NULL, type_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, status INTEGER NOT NULL, has_description VARCHAR(10) NOT NULL, has_description_with_gaps VARCHAR(10) NOT NULL, CONSTRAINT FK_799A3652B03A8386 FOREIGN KEY (created_by_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_799A365282F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_799A365277E5854A FOREIGN KEY (mode_id) REFERENCES mode (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_799A3652C54C8C93 FOREIGN KEY (type_id) REFERENCES illustration_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO nomenclature (id, created_by_id, language_id, mode_id, type_id, created_at, name, status, has_description, has_description_with_gaps) SELECT id, created_by_id, language_id, mode_id, type_id, created_at, name, status, "Unknown", "Unknown" FROM __temp__nomenclature');
