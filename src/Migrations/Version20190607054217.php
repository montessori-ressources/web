 ...
 */
final class Version20190607054217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__nomenclature AS SELECT id, created_at, name FROM nomenclature');
        ...
        $this->addSql('INSERT INTO nomenclature (id, created_at, name) SELECT id, created_at, name FROM __temp__nomenclature');
