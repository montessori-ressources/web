 ...
 */
final class Version20190422174642 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__card AS SELECT id, nomenclature_id, label, description, description_with_gaps FROM card');
        ...
        $this->addSql('INSERT INTO card (id, nomenclature_id, label, description, description_with_gaps) SELECT id, nomenclature_id, label, description, description_with_gaps FROM __temp__card');
